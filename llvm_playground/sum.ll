...
@.str = private unnamed_addr constant [28 x i8] c"The sum of %d and %d is %d\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %10 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %7, i32 noundef %8, i32 noundef %9)
  ret i32 0
}
